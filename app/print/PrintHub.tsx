...
export default function PrintHub() {
  ...
  useEffect(() => {
    setOrder(localStorage.getItem('print.lastOrder') || '');
  }, []);
  useEffect(() => {
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-8">
      ...
      <p className="text-slate-600 mb-6">
        ...
        В чеке строки «Заказ: …» нет. QR ведёт на ссылку по <b>числовому ID</b>.
      </p>
      ...
      <div className="mt-8 rounded-2xl border border-slate-200 bg-slate-50 p-4 text-sm text-slate-600">
        ...
        <ul className="list-disc pl-5 space-y-1">
          ...
          <li><span className="font-mono">/print/receipt?order=RF25KT100010</span> — печать по штрихкоду; резолвим в числовой ID и используем только его.</li>
