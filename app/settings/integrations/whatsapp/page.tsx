...
// Шаблон day 3 — «Как ваши очки?» (адаптация).
...
// Шаблон day 12 — напоминание о праве на замену по комфорту/посадке.
// Имя `aftercare_day12_warranty_ru` (старое `aftercare_day12_guarantee_ru` удалено в Meta).
const DAY12_TEMPLATE_NAME = 'aftercare_day12_warranty_ru';
const DAY12_TEMPLATE_CATEGORY = 'UTILITY';
const DAY12_TEMPLATE_LANGUAGE = 'Russian (ru)';
const DAY12_TEMPLATE_BODY = `Здравствуйте! Через 2 дня у вас заканчивается 14-дневная гарантия адаптации на очки. Если что-то не подошло по комфорту или посадке — можем бесплатно поменять оправу и линзы в той же ценовой категории. Просто заходите без записи. А если всё хорошо — носите на здоровье.`;
